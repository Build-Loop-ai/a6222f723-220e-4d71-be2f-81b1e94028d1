    ...
    <aside className="hidden md:flex bg-sidebar border-r border-sidebar-border h-screen sticky top-0 transition-all duration-300 flex-col w-64">
      ...
      <div className="p-4 border-t border-sidebar-border space-y-2">
        ...
        <button
          ...
          className="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sidebar-foreground/70 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground transition-all w-full text-sm"
        >
